...
import { generateProjectId, getStatusGradient, sortProjectsByScore } from './utils/projectUtils'
...
const initialProjects: Project[] = [
  // === BUILD NOW ===
  {
    ...
    scale: 8,
    status: 'BUILD NOW',
    action: 'Adaptive discovery engine: genre-selective music paths, SEO/GEO, blog refactor.',
  },
  {
    id: '2',
    name: 'Project Jasper (AWS/Clawdbot)',
    category: 'Tech (Core)',
    enjoyment: 9,
    resources: 10,
    viability: 9,
  ...
  },
  {
    ...
    scale: 10,
    status: 'BUILD NOW',
    action: 'Complete current course module THIS WEEK.',
  },
  ...
  // === PRIORITIZE ===
  {
    ...
    scale: 7,
    status: 'PRIORITIZE',
    action: "Rename from 'codex' (OpenAI stole it). Persona-based routing. SEO driver. IN-FLIGHT.",
  },
  {
    id: '5',
  ...
  },
  {
    ...
    scale: 4,
    status: 'PRIORITIZE',
    action: 'Deploy to Netlify. Add data export. Weekly check-in ritual.',
  },
  {
    id: '7',
    ...
    scale: 5,
    status: 'PRIORITIZE',
    action: 'Could feed into travisBREAKS music experience. Deploy standalone + integrate.',
  },
  {
    id: '8',
    name: 'Roots, Ruin, Redemption EP',
    category: 'Creative',
    enjoyment: 10,
    resources: 9,
    viability: 8,
    scale: 4,
    status: 'PRIORITIZE',
    action: "Finish mix for 'The People Tree'.",
  },
  {
    id: '9',
    name: 'Song: BPD Compassion',
    category: 'Creative',
    enjoyment: 9,
    resources: 10,
    viability: 8,
    scale: 6,
    status: 'PRIORITIZE',
    action: 'Record scratch vocal.',
  },
  {
    id: '10',
    name: 'Song: Psychosis vs Awakening',
    category: 'Creative',
    enjoyment: 9,
    resources: 10,
    viability: 8,
    scale: 5,
    status: 'PRIORITIZE',
    action: 'Draft lyrics in blog.',
  },
  {
    id: '11',
    name: 'Personal Finance (DCA)',
    category: 'Lifestyle',
    enjoyment: 5,
    resources: 8,
    viability: 10,
    scale: 9,
    status: 'PRIORITIZE',
    action: 'Set auto-transfer; forget it exists.',
  },
  ...
  },
  {
    ...
    scale: 3,
    status: 'SUSTAIN',
    action: 'SHIPPED. May evolve as blog refactor lands.',
  },
  {
    id: '16',
    name: 'Suno Prompting System',
    category: 'Creative',
    enjoyment: 7,
    resources: 10,
    viability: 9,
    scale: 2,
    status: 'SUSTAIN',
    action: 'Transfer from ChatGPT to Jasper.',
  },
  {
    id: '17',
    name: 'Jurassic Coders (Satire)',
    category: 'Content',
    enjoyment: 8,
    resources: 10,
    viability: 7,
    scale: 6,
    status: 'SUSTAIN',
    action: 'Post only when bored; zero pressure.',
  },
  {
    id: '18',
    name: 'Sandcastle Dreams (Video)',
    category: 'Creative',
    enjoyment: 9,
    resources: 7,
    viability: 5,
    scale: 6,
    status: 'SUSTAIN',
    action: 'Mocap testing only; do not animate full eps.',
  },
  {
    id: '19',
    name: "Dudes 'n Dragons Media",
    category: 'Content',
    enjoyment: 8,
    resources: 8,
    viability: 6,
    scale: 5,
    status: 'SUSTAIN',
    action: 'Hobby category, not brand.',
  },
  {
    id: '20',
    name: 'Spirituality Brand',
    category: 'Business',
    enjoyment: 5,
    resources: 8,
    viability: 6,
    scale: 6,
    status: 'SUSTAIN',
    action: 'Put content on travisBREAKS blog.',
  },
  {
    id: '21',
    name: 'Project 1137',
  ...
  // === WATCH / EXPERIMENTAL ===
  {
    ...
    scale: 5,
    status: 'WATCH',
    action: 'Absorbing into travisBREAKS adaptive music layer. Not standalone.',
  },
  {
    id: '23',
  ...
  },
  {
    ...
    scale: 5,
    status: 'WATCH',
    action: 'Collect data; do not buy land yet.',
  },
  {
    id: '27',
    ...
    scale: 2,
    status: 'WATCH',
    action: "Do it for fun; don't sell it.",
  },

  // === KILL/ARCHIVE ===
  {
    id: '28',
    name: "Men's Community / Red Pill",
    category: 'Business',
    enjoyment: 4,
    resources: 6,
    viability: 5,
    scale: 7,
    status: 'KILL/ARCHIVE',
    action: 'High burnout; low joy.',
  },
  {
    id: '29',
    name: 'Homelessness Venture',
    category: 'Business',
    enjoyment: 6,
    resources: 2,
    viability: 3,
  ...
  },
  {
    ...
    scale: 10,
    status: 'KILL/ARCHIVE',
    action: "Requires millions you don't have.",
  },
  {
    id: '31',
    name: 'Amazon/SBA Funding',
    category: 'Business',
    enjoyment: 4,
    resources: 2,
    viability: 3,
  ...
  },
  {
    ...
    scale: 8,
    status: 'KILL/ARCHIVE',
    action: 'You are buying a job you will hate.',
  },
  {
    id: '33',
    name: 'Crypto Mining (Home)',
    category: 'Business',
    enjoyment: 3,
    resources: 4,
    viability: 2,
    scale: 3,
    status: 'KILL/ARCHIVE',
    action: '3000W heat/noise is sovereign hell.',
  },
  {
    id: '34',
    name: 'Adv. Creative Web Dev Tech Stack',
    category: 'Business',
    enjoyment: 8,
    resources: 6,
    viability: 5,
    scale: 7,
    status: 'KILL/ARCHIVE',
    action: 'Absorbed into Jasper development.',
  },
]
    ...
    >
      ...
      <div className="flex flex-col gap-2 pr-12">
        ...
        <div className="flex items-center gap-2 mb-1">
          <span className={cn('p-1 rounded bg-gray-800/50', isTop3 ? 'text-neon-pink' : 'text-gray-400')}>
